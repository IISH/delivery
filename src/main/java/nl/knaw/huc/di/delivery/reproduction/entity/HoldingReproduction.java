package nl.knaw.huc.di.delivery.reproduction.entity;
...
public class HoldingReproduction extends HoldingRequest {
    ...
    public static final String CUSTOM_REPRODUCTION_REPLY = "customreproductionreply";
    ...
    @SequenceGenerator(
            ...
            sequenceName = "holding_reproductions_id_seq",
            allocationSize = 50
    )
    @Column(name = "id")
    private Integer id;
     ...
     */
    @Column(name = CUSTOM_REPRODUCTION_REPLY, columnDefinition = "TEXT")
     ...
     *
     * @param request set the value of the request
     */
    @Override
    ...
    public void mergeWith(HoldingRequest other) {
        ...
        if (other instanceof HoldingReproduction otherHr) {
