package nl.knaw.huc.di.delivery.permission.entity;
...
public class Permission {
     ...
     */
    @Column(name = "inv_nos_granted", columnDefinition = "VARCHAR ARRAY", nullable = false)
    ...
    public boolean hasGranted(Record rec) {
        ...
        boolean containsInvNo = invNosGranted.contains(rec.getHoldings().getFirst().getSignature());
