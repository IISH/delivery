...
import nl.knaw.huc.di.delivery.reservation.dao.ReservationDateExceptionDAO;
...
public class ReservationDateExceptionServiceImpl implements ReservationDateExceptionService {
    private final ReservationDateExceptionDAO reservationDateExceptionDAO;
    private final MessageSource messageSource;

    public ReservationDateExceptionServiceImpl(ReservationDateExceptionDAO reservationDateExceptionDAO, MessageSource messageSource) {
        this.reservationDateExceptionDAO = reservationDateExceptionDAO;
    ...
    public Page<ReservationDateException> findAll(CriteriaQuery<ReservationDateException> q, Pageable pageable) {
        return reservationDateExceptionDAO.findAll(q, pageable);
    }
