package nl.knaw.huc.di.delivery.record.entity;
...
public class Record {
    ...
    public String toString() {
        ...
        if (isArchive) {
            sb.append(" - ");
            if (getParent() != null) {
                sb.append(getParent().getHoldings().getFirst().getSignature());
                sb.append(" - ");
            }
            sb.append(getHoldings().getFirst().getSignature());
        }
