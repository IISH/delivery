...
public class Reproduction extends Request {
     ...
     */
    @Id@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "global_sequence_generator")
    @SequenceGenerator(
            name = "global_sequence_generator",
            sequenceName = "reproductions_id_seq",
            allocationSize = 50
    )
    @Column(name = "id")
    private Integer id;
...
//    private String orderId;
    ...
    public Request mergeWith(Request request) {
        if (request instanceof Reproduction reproduction) {
...
//            this.orderId = reproduction.getOrderId();
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Reproduction other) {
